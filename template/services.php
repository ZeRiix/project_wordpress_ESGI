...
<div class="w-[100%] h-[1836px] relative">
    <div class="w-[1800px] h-[991px] left-0 top-[845px] absolute">
        <div class="w-[1800px] h-[631px] left-0 top-[360px] absolute">
            <img class="w-[1800px] h-[631px] left-0 top-0 absolute" src="https://via.placeholder.com/1800x631" />
            <img class="w-[1800px] h-[631px] left-0 top-0 absolute" src="https://via.placeholder.com/1800x631" />
        </div>
        <div
    ...
    <div class="w-[1800px] h-[714px] left-0 top-0 absolute">
        <div class="w-[480px] h-[480px] left-[1440px] top-[234px] absolute">
            <img class="w-[480px] h-[480px] left-0 top-0 absolute" src="https://via.placeholder.com/480x480" />
            <img class="w-[480px] h-[480px] left-0 top-0 absolute" src="https://via.placeholder.com/480x480" />
        </div>
        <div class="w-[480px] h-[480px] left-[960px] top-[234px] absolute">
            <div class="w-[480px] h-[480px] left-0 top-0 absolute bg-zinc-300"></div>
            <div class="w-[480px] h-[480px] left-0 top-0 absolute bg-zinc-300"></div>
            <img class="w-[807.38px] h-[539px] left-[-164.19px] top-[-59px] absolute"
                src="https://via.placeholder.com/807x539" />
