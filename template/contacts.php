<?php get_header(); ?>
<div class="w-[100%] h-[1955px] relative">
    <div class="w-[1052px] h-[595px] left-[2px] top-[1360px] absolute">
        <div class="w-[1052px] h-[401px] left-0 top-[194px] absolute">
            <div
                class="w-[76px] h-[25px] pr-px left-[1px] top-[376px] absolute justify-center items-center inline-flex">
                <div class="text-slate-900 text-xl font-extrabold tracking-wide">Submit</div>
            </div>
            <div class="w-[1051px] h-[178px] left-[1px] top-[159px] absolute">
            ...
            <div
                class="w-[501px] h-12 left-[551px] top-[80px] absolute flex-col justify-center items-start gap-2 inline-flex">
                <div class="text-zinc-400 text-xl font-normal leading-[38px]">Phone no.</div>
            </div>
            <div class="w-[502px] h-12 left-0 top-[80px] absolute">
                <div class="left-0 top-0 absolute text-zinc-400 text-xl font-normal leading-[38px]">Email</div>
            </div>
            <div
                class="w-[1051px] h-12 left-[1px] top-0 absolute flex-col justify-center items-start gap-2 inline-flex">
                <div class="text-zinc-400 text-xl font-normal leading-[38px]">Subject</div>
            </div>
        </div>
        <div
            class="w-[564px] h-[42px] pr-[363px] pt-[7px] left-0 top-[88px] absolute justify-start items-center inline-flex">
            <div class="text-zinc-500 text-[26px] font-normal leading-[42px]">Go! Don’t be shy.</div>
        </div>
        <div class="w-[434px] h-[79px] pr-[3px] left-0 top-0 absolute justify-center items-center inline-flex">
    ...
    <div class="w-[911px] h-[189px] left-0 top-0 absolute">
        <div
            class="w-[909px] h-[42px] pr-[134px] pt-[3px] left-[2px] top-[147px] absolute justify-start items-center inline-flex">
        ...
        <div class="w-[373px] h-[105px] pr-px left-0 top-0 absolute justify-center items-center inline-flex">
