            ...
            <article>
                <a href="<?= get_permalink($post->ID) ?>" class="flex gap-[25px]">
                    ...
                    <div class="flex flex-col justify-between flex-1 content">
                        ...
                        <time class="text-xs lg:text-sm text-zinc-500"><?= wp_date('j F Y', strtotime($post->post_date)) ?></time>
                    </div>
                </a>
            </article>
    ...
    <div>
        ...
        <ul class="flex flex-col gap-[20px] categories">
            ...
            <li class="flex items-center">
                <a href="<?= get_category_link($category->term_id) ?>" class="flex gap-[10px] text-lg lg:text-xl text-zinc-500">
                    <?= $category->name ?>
                </a>
            </li>
            <?php 
